...
<form style=" text-align: center;" method="POST" action="modificarUsuario.php">
...
<!--nombre a modificar-->
<div class="form-group">
<label for="nombre_mod">Nombre usuario modificar:</label><br>
<input type="text" name="nombre_usuario_modificar" maxlength="255" required>
</div>

 <br/><br/>
 <input type="submit" name="submit" class="btn btn-primary" value="modificar"> 
 <button type="button" class="btn" style="background-color:white"> <a href="./login.php" ><font color="black">Login</font></a></button>  
 <button type="button" class="btn" style="background-color:white"> <a href="./dashboard.php" ><font color="red">Regresar</font></a></button>  
